...
//void APooledObject_Sphere::OnBeginOverlap(UPrimitiveComponent* OverlappedComp, AActor* OtherActor, UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
//{
//	if (AttackComplete)
//	{
//		return;
...
//	{
//		FDamageEvent DamageEvent;
//		HitEnemy->TakeDamage(15.f, DamageEvent, MyPawn->GetController(), this);
//
//		AttackComplete = true;
//		SetActive(false);
//		OnPooledObjectDespawn.Broadcast(this);
...
//		FDamageEvent DamageEvent;
//		HitEnemy->TakeDamage(15.f, DamageEvent, MyPawn->GetController(), this);
//		//HitEnemy->TakeDamage(15.f, DamageEvent, MyPawn-> GetOwner()->GetInstigatorController() /*OtherActor->GetInstigatorController()*/, GetOwner());
//		AttackComplete = true;
//		SetActive(false);
//
//		if (Particle)
//		{
//			//UGameplayStatics::SpawnEmitterAtLocation(GetWorld(), Particle, OtherActor->GetTransform());
//			UGameplayStatics::SpawnEmitterAtLocation(GetWorld(), Particle, HitEnemy->GetTransform());
//		}
//	}
//}
